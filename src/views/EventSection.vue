...
#BookExhibition {
  background: linear-gradient(#00000079, #00000079),
    url(../assets/images/guests/bookexhibition.svg);
}
      ...
      guests: [
        {
          ...
          guestImage: require("../assets/images/guests/standup.svg"),
          eventabout:
        ...
        {
          guestName: "Dastaan",
          guestImage: require("../assets/images/guests/daastan.svg"),
          eventabout:
        ...
        {
          guestName: "Poetry",
          guestImage: require("../assets/images/guests/poets.svg"),
          eventabout:
